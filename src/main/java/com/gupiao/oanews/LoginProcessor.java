...
public class LoginProcessor {
    ...
    public static void main(String[] args) {
        ...
        driver.get("http://oa.xiaoniu66.com/login.jsp");

        driver.findElement(By.name("j_username")).clear();

        //在******中填你的用户名
        driver.findElement(By.name("j_username")).sendKeys("xn065109");

        driver.findElement(By.name("j_password")).clear();
        //在*******填你密码
        driver.findElement(By.name("j_password")).sendKeys("zhuxing123");

        //模拟点击登录按钮
        WebElement ele = driver.findElement(By.name("btn_submit2"));
        driver.findElement(By.name("btn_submit2")).click();
